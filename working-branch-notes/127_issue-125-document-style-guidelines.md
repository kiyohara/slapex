...
- 2026-07-04: レビュー指摘 3 件に対応。(1) Cursor / Claude Code 入口 rule から文体方針の本文複製を削除し参照のみに変更、(2) progress.md の help-06 行の PR 列に #127 を記入、(3) merge 順(PR #127 → #124)を踏まえ、quickstart の文体は PR #124 内で新ガイドラインへ合わせる整理に変更し、#126 の対象から quickstart を外して依存を #125 のみに簡素化(decision log 0048 の影響節も同期)。
