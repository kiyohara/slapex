...
Issue 整理時の考慮漏れを受け、#154 と同等の日時入力仕様を #153 の description と実装へ反映した。共有 parser、local calendar date への正規化、CLI / export test、関連文書を更新し、必須検証と README GIF の再録画・目視確認まで完了している。
