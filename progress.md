...
v1.0.0 / v1.0.1 / v1.1.0 を GitHub Releases で公開済み。v1.1.1 は release 準備中。配布経路は単一バイナリ(GitHub Releases)、install script(`scripts/install.sh`)、Homebrew cask(`kiyohara/homebrew-tap`)の 3 つ。
...
| v1.1.1 | preparing | `--reuse-cache` の出力ディレクトリ検出改善、exported HTML header / footer 調整、logo asset 追加を含む patch release 準備中 |
