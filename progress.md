...
| RF-01 | [#189](https://github.com/kiyohara/slapex/issues/189) test準備集約 | done(PR merge後) | #188 | merge後にRF-02へ | [#200](https://github.com/kiyohara/slapex/pull/200) |
| RF-02 | [#190](https://github.com/kiyohara/slapex/issues/190) export分割・命名 | done(PR merge後) | #188 | merge後にRF-03へ | [#201](https://github.com/kiyohara/slapex/pull/201) |
...
| FU-03 | [#204](https://github.com/kiyohara/slapex/issues/204) URL 無し upload が外部連携表示 | done(PR merge後) | - | merge後は対応なし。ユーザー判断で RF-03 より先行して実施 | [#243](https://github.com/kiyohara/slapex/pull/243) |
...
| FU-07 | [#208](https://github.com/kiyohara/slapex/issues/208) upload_thumb manifest の mimetype / size | done(PR merge後) | - | merge後は対応なし。ユーザー判断で RF-03 / RF-06 より先行して実施 | [#244](https://github.com/kiyohara/slapex/pull/244) |
...
| FU-11 | [#222](https://github.com/kiyohara/slapex/issues/222) 同一ファイル再利用時の summary 文言 | done(PR merge後) | PR #221 | merge後は対応なし。推奨順より先行して実施 | [#236](https://github.com/kiyohara/slapex/pull/236) |
