...
| help-05 | #123 | done | #49 / #52 / #125 / #129 後 | (完了)README をキャッチーな入口 + 誘導リンク集へ再構成し、インストール詳細を `doc/help/installation.md`、使い方・出力詳細を `doc/help/usage.md` へ移設。利用者向け文書の開発者向けリンクは #129 の方針(文末脚注)へ統一 | - |
