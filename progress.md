...
| FU-04 | [#205](https://github.com/kiyohara/slapex/issues/205) unfurl text の mention 未解決 | done(PR merge後) | - | merge後は対応なし。推奨順より先行して実施 | [#241](https://github.com/kiyohara/slapex/pull/241) |
